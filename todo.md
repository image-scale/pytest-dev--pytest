...
- [x] Task 9: Monkeypatch utility for temporarily modifying attributes, dictionary entries, environment variables, and sys.path during tests
- [x] Task 10: Stdout/stderr capture fixture that lets tests inspect what was printed during execution
- [x] Task 11: Temporary directory fixtures that provide unique per-test temp paths with automatic cleanup
